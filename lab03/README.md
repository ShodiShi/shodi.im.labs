...
Восстановление леса: `BURNED → YOUNG → TREE`. Молодые деревья уязвимее взрослых — загораются при наличии горящего соседа без проверки вероятности (100%). Взрослеют за ~25 шагов.
