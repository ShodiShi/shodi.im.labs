...
**Правило 1 — Дерево загорается от соседа**   
Дерево проверяет всех 8 соседей. Если хотя бы один горит — бросается кубик. 82% шанс загореться. Если горящий сосед находится с наветренной стороны — вероятность вырастает до 100%.

**Правило 2 — Дерево загорается от молнии**  
Если ни один сосед не поджёг — проверяется молния. 0.03% шанс для каждого дерева за шаг. На 5000 деревьях это ~1-2 молнии за каждый шаг. Запускает новые очаги пожара.

**Правило 3 — Дерево остаётся деревом**   
Если ни сосед не поджёг, ни молния не ударила — дерево живёт дальше.

**Правило 4 — Горящая клетка становится пеплом**  
Горение длится ровно 1 шаг — детерминированно, без вероятности. Именно поэтому огонь движется а не стоит на месте.

**Правило 5 — Пепел даёт росток или остаётся пеплом** 
Каждый шаг каждая клетка пепла имеет 0.7% шанс дать росток. Не зависит от соседей. За ~143 шага восстанавливается с вероятностью 63%.

**Правило 6 — Пустая клетка остаётся пустой**   
Огонь на пустое место не переходит — только на деревья.

### Дополнительные правила

**Правило Д1 — Мокрые клетки (WET)** 
Моделируют реки и болота. Мокрая клетка никогда не становится `BURNING` — огонь через неё не проходит. 0.2% шанс дать росток за шаг — медленно высыхает.

**Правило Д2 — Сукцессия растительности (YOUNG)** 
Молодые деревья уязвимее взрослых — загораются при наличии горящего соседа без проверки вероятности (100%). Взрослеют с вероятностью 4% за каждый шаг. За 73 шага вырастает с вероятностью 95%.

**Правило Д3 — Летящие искры (EMBER)**  
Горящая клетка с шансом 1.3% выбрасывает искру, которая летит на 3–10 клеток по направлению ветра со случайным отклонением ±2 клетки. Поджигает дерево или тлеет на пустом месте ещё 1 шаг.
...
| `wind_boost` | 0.28 | Усиление огня по направлению ветра |
